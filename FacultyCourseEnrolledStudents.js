...
const FacultyCourseEnrolledStudents = () => {
              ...
              {info.Students.map((student) => (
                <tbody>
                  <tr key={student.stud_id}>
                    ...
                    <td>
                      <Link
                        to={`/faculty/${facId}/courses/${courseId}/studentsEnrolled/updateGrade/${info.courseName.name}/${student.stud_id}/${student.name}`}
                        className="-link"
                      >
...
export default FacultyCourseEnrolledStudents;
